...
root=Tk()
root.title("AJ SCHOOL OF TECHNOLOGY")
...
def newadm():
    ...
    l3=Label(top,text="Class :-  ",font=("andalus",18)).place(x=11,y=269)
    l4=Label(top,text="Section allocated :-  ",font=("andalus",18)).place(x=11,y=335)
    l6=Label(top,text=value,font=("andalus",18),bg="Black",fg="White").place(x=225,y=328)
    l5=Label(top,text="Enter ROLL NO. :-  ",font=("andalus",18)).place(x=11,y=410)
    global e3
    e3=Entry(top,width=10,relief="solid",bg="white",font=("andalus",16))
    ...
    global clicked
    clicked=IntVar()
    OptionMenu(top,clicked,*l).place(x=105,y=259,width=68,height=40)
    global clicked1
    clicked1=StringVar()
    OptionMenu(top,clicked1,"M","F","TRANSGENDER").place(x=115,y=191,width=191,height=40)
    l7=Label(top,text="Pay Fees:-",font=("andalus",18)).place(x=431,y=60)
    global e4
...
def loginwin():
    #if en1==us and en2==pw:
    stdlogin1()
    #else:
       # messagebox.showerror("AJ SCHOOL OF TECHNOLOGY","Incorrect username or password!!!\n please try again")
...
def click_confirm1():
    try  :
        if int(e4.get())==a:
            response=messagebox.askquestion("AJ SCHOOL OF TECHNOLOGY","Please check your responses thoroughly.\nClick OK if they are correct or else go back.")
            if response=="yes" :
                mycon=con.connect(host="localhost",user="root",passwd="jitu75",database="studentdetail")
                cursor=mycon.cursor()
                st="insert into student values({},'{}',{},{},'{}','{}','{}',{},{})".format(int(e3.get()),str(e.get()),int(e1.get()),int(clicked.get()),value,str(clicked1.get()),value1,int(e4.get()),0)
                cursor.execute(st)
                mycon.commit()
                mycon.close()
                e3.delete(0,END)
        ...
        1.After completing the admission formalities you will be able to access the student login section in order to get your detail's as \nregistered with the school.
        2.Username=ASD#34 , Password=AJ@23 all character's are case sensitive.
        ...
        4.Please limit your access to student section of the main page only.DO NOT TRESSPASS TO OTHER SECTIONS.
        5.Other details will be shared with you in due course of time.

                                                                                                                THANK YOU
                                                                                                                -AJ SCHOOL OF TECHNOLOGY'''
                text_box=Text(top,font=("Monotype Corsiva",16))
                text_box.place(x=550,y=170,width=1015,height=610)
                text_box.insert('end',message)
                text_box.config(state='disabled')
            else:
                pass
        else:
            messagebox.showerror("AJ SCHOOL OF TECHNOLOGY","You haven't paid the fees yet\nPlease pay Rs.1000 as fees to continue")
    except :
...
def click_confirm3():
    try:
        ...
        messagebox.showerror("AJ SCHOOL OF TECHNOLOGY","Please try again.\nFill integer value in the ROLL NO. section. ")
...
def click_confirm4():
    try:
        ...
        messagebox.showwarning("AJ SCHOOL OF TECHNOLOGY","Please fill  at least ROLL NUMBER to continue ")
...
def click_confirm5():
    try:
        if int(e10.get())==b:
            ...
            top2.title("AJ SCHOOL OF TECHNOLOGY")
            ...
            top3.title("AJ SCHOOL OF TECHNOLOGY")
        ...
        messagebox.showerror("AJ SCHOOL OF TECHNOLOGY","ERROR!!!,Please try again.")
...
def click_confirm7():
    try:
        ...
        messagebox.showerror("AJ SCHOOL OF TECHNOLOGY","Record no found!!!")
...
def click_confirm6():
    ...
    5.Other details will be shared with you in due course of time.
        ...
        messagebox.showerror("AJ SCHOOL OF TECHNOLOGY","ERROR!!!\nIncorrect detail's filled.\nPlease try again. ")
...
def click_confirm11():
    try:
        ...
        messagebox.showwarning("AJ SCHOOL OF TECHNOLOGY","Please fill  Id to continue ")
def click_confirm12():
    try:
        mycon=con.connect(host="localhost",user="root",passwd="jitu75",database="studentdetail")
        cursor=mycon.cursor()
...
label1=Label(root,text="WELCOME TO AJ SCHOOL OF TECHNOLOGY",font=("times new roman", 35),bg="Black",fg="White").pack(side=TOP,fill=X)
labelframe = LabelFrame(root, text="STUDENT",bd=10,font=("times new roman", 18),bg="blue",fg="white")
labelframe.place(x=40,y=80)
button1=Button(labelframe,text="NEW ADMISSION",command=newadm,padx=78,pady=50,bg="green",fg="white").pack(padx=20,pady=20)
button2=Button(labelframe,text="TRANSFER CERTIFICATE",command=transfer_certificate,padx=62,pady=50,bg="green",fg="white").pack(padx=20,pady=20)
button3=Button(labelframe,text="STUDENT LOGIN",command=stdlogin,padx=81,pady=55,bg="green",fg="white").pack(padx=20,pady=20)
button4=Button(labelframe,text="FEE PAYMENT",command=feepay,padx=88,pady=55,bg="green",fg="white").pack(padx=20,pady=20)
